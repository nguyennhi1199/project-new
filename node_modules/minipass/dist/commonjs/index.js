...
class Minipass extends node_events_1.EventEmitter {
     ...
     * the event will be deferred until after 'end' is e									<xsl:when test ="count(./b:Source/b:Author/b:Conductor/b:NameList/b:Person/b:Last)>0">
			...
			<xsl:when test="./b:Source/b:SourceType='Performance'">
				<xsl:choose>
					<xsl:when test="string-length(./b:Source/b:Author/b:W buf = await this.collect();
        return (this[ENCODING]
            ? buf.join('')
     ...
     *
     * If an error argument is provided, then irmerLF)>0">
