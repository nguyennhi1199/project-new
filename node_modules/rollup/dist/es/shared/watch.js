...
class Task {
    ...
    watchFile(id, isTransformDependency = false) {
        if (!this.filter(id))
            return;
        this.watched.add(id);
  …∫STﬂ<>äÒSØD˜üRzf˛|˘¬·ªK˜ùø'û”Ò◊W<€h˝[ﬁ†ﬂ"?ÛGeıÈ? 7X= i_Ú»yﬂ’?ØGΩx"|Ù’”Øœ«<CWUˇ¬ıœ·Ùœü—Ó˜≥ô“ÕOmdS>Êmù^ewƒ~Ö]ÊÓgv◊_LÁOxw¶”’=◊ù/}Ω¡µÂôG	ãñxvÚ?Â√/‚ós(ﬂÔÿﬁÇÓøŒzˇPÿ°∏m;ˇΩ◊Øçh√{‚	ªÜ˝pbWDì√ë´cVG…GØâæÙÌ›ÚÌ‚Ú∆+„Æ~9§ÎüBq¸˙…›˜/wJ~∏Lñ≤Ê–∞‘∏!Ûﬁ¯˝˚Ù¢πÈ_Fˆ÷L¨Ë≥yÀ¯æ‚Á~ﬂüñÙÁ-ï˜œ>?z¿ç/û©€PÎÛá~ïπpËÖµKáﬁ::lrÃºa?∏ù